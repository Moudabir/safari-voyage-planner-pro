...
export const TripSelector = ({ trips, currentTrip, onTripSelect, onTripsUpdate }: TripSelectorProps) => {
        ...
        <div className="space-y-4">
          ...
          {isCreating ? (
            ...
            <Button
              ...
              className="w-full border-dashed border-2 border-muted-foreground/25 bg-muted/50 hover:bg-muted"
              variant="outline"
            >
